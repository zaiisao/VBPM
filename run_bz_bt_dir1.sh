#!/bin/bash
# OVERNIGHT: CHART on Beat This + bar_phase + z_forcing, MAX-PERFORMANCE (dir1 crutches kept:
# phase/meter/taubar supervision + scheduled sampling + audio_recon). Best shot at beating
# Beat This and probing the SMC blind spot. Eval on clean + SMC in the morning.
...
exec $CH -m training.train \
  ...
  --save_ckpt_path checkpoints/bz_bt_dir1_fix/chart.pt
